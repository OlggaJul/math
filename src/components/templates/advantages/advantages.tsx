...
const advantages: Advantages = [
  ...
  { id: 3, title: 'Безкоштовне додаткове заняття', desc: 'Для учнів, котрі готуються до НМТ, щотижня проводжу заняття, де ми розбираємо найскладніші для тебе завдання або тему' }
]
